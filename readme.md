...
Another font has installed for vim called Inconsolata regular created by Raph Levien. It is a monospace font, designed for code listings and the like, in print. In order to get maximum result, ensure you enable subpixel anti-aliasing iterm.
