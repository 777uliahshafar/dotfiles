...
Another font has installed for vim called Inconsolata regular 19 created by Raph Levien. It is a monospace font, designed for code listings and the like, in print. In order to get maximum result, ensure you enable use built-in poweline glyphs iterm.
...
7. Mac_classic and dracula are schemes for vim. Mac_classic is a customized colorscheme by drewneil. The mac_classic.vim already copied to dotfiles.
